...
function display() {
    ...
    for (let i = 0; i < 10; i++) {
        ...
        for (let j = 0; j < 10; j++) {
            if(arr[i][j]=="x"){
                stringTable += '<td onclick="play(' + i + ' ,' + j + ')" style="width: 40px; height: 40px; class="red" " >' + arr[i][j] + '</td>';
            }else{
                stringTable += '<td onclick="play(' + i + ' ,' + j + ')" style="width: 40px; height: 40px; class="blue" " >' + arr[i][j] + '</td>';
            }
